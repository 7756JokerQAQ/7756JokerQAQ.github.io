...
![image-20230101193326282](https://joker-qaq1-1314468534.cos.ap-beijing.myqcloud.com/learn/3481/image-20230101193326282.png)

他类似一个配置中心来管理各个客户端保证数据的统一性：即访问不同的服务器得到相同的数据。

![image-20230101193352872](https://joker-qaq1-1314468534.cos.ap-beijing.myqcloud.com/learn/3481/image-20230101193352872.png)

# 二、zookeeper 数据模型

zookeeper是一个属性目录服务、其数据模型和Unix的文件系统相类似，拥有一个层次化的结构。它类似于一个树形的结果如图：

![image-20230101193833720](https://joker-qaq1-1314468534.cos.ap-beijing.myqcloud.com/learn/3481/image-20230101193833720.png)
...
![image-20230101194716844](https://joker-qaq1-1314468534.cos.ap-beijing.myqcloud.com/learn/3481/image-20230101194716844.png)
