...
![image-20230319145450450](/img/cos/202303191454501.png)

主要进行分区快的查询，一个去查询订单数据库信息，一个查询用户模块的信息，总的组成了一个用户的全部信息。

**微服务调用的实例:**

![image-20230319145804998](/img/cos/202303191458094.png)
...
![image-20230319150708060](/img/cos/202303191507095.png)
...
![image-20230319151207323](/img/cos/202303191512429.png)
...
![image-20230319153448836](/img/cos/202303191534901.png)

默认的原则是轮询，具体底层原理:

![image-20230319153549009](/img/cos/202303191535080.png)
...
![image-20230319154034973](/img/cos/202303191540054.png)
